  ...
  const testimonials = [
    {
      ...
      source: "LinkedIn",
      profile_image:
        "https://media.licdn.com/dms/image/v2/C5603AQF0sTMnPxXkbg/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1516350180587?e=1742428800&v=beta&t=rMCOEdFn7BYqco2hyuE4FAuSemHuR1K_uw4gLWjNEKo",
    },
    {
      id: "d8c2f6a9b5",
      name: "Joel English",
      ...
      source: "LinkedIn",
      profile_image:
        "https://media.licdn.com/dms/image/v2/D4E03AQHLpOLtJZeFfw/profile-displayphoto-shrink_100_100/profile-displayphoto-shrink_100_100/0/1726595037235?e=1742428800&v=beta&t=jOfWjObmTfMozRpF7ZEQU2ia4jmwm9qZN-rVst0EaQQ",
    },
    {
      id: "e4a7d9c8f1",
      name: "Mike Vaughn",
      ...
      source: "LinkedIn",
      profile_image:
        "https://media.licdn.com/dms/image/v2/C5603AQGVIyDeagNz1g/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1517413180941?e=1742428800&v=beta&t=XzCV-WNiht4u9h2CmtoFIEaKbY283l0aAMblBIIHkBU",
    },
    {
      id: "f6d8b3c7a2",
      ...
      source: "LinkedIn",
      profile_image:
        "https://media.licdn.com/dms/image/v2/C4E03AQEzkqah4-98SQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1644368734991?e=1742428800&v=beta&t=jZUF7nBjpkhvKkrXW83CiY3ThhyJYgcK5WTobgEy_NA",
    },
  ];
  return (
    <>
      <HeroHeader
        title={"Testimonials"}
        h={"h1"}
        subtitle={`Here’s what colleagues and clients have shared about working with
            me. Their feedback highlights my dedication to clean design,
            innovative problem-solving, and creating impactful user experiences.`}
      />
